...
class OrderSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Order
        fields = [
            'id', 'order_no', 'buyer', 'buyer_username', 'seller', 'seller_username',
            'product', 'product_title', 'product_image', 'price', 'status', 'status_display',
            'address_snapshot', 'created_at', 'paid_at', 'shipped_at', 'completed_at',
            'cancel_time', 'tracking_number', 'shipping_company',
        ]
        read_only_fields = [
            'buyer', 'seller', 'product', 'price', 'created_at',
            'paid_at', 'shipped_at', 'completed_at', 'cancel_time',
        ]
